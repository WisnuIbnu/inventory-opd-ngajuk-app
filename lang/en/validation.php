...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris kalimat berikut berisi pesan kesalahan standar yang digunakan oleh
    ...
    */
    ...
    'alpha_dash' => ':attribute hanya boleh berisi huruf, angka, garis sambung, dan garis bawah.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris kalimat berikut digunakan untuk menukar placeholder atribut dengan 
